    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-[calc(100vh-64px)] p-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="flex gap-2 mb-4">
          <button
            className={`btn flex-1 ${filterType === "category" ? "btn-primary" : "bg-base-100 hover:bg-base-200"}`}
            onClick={() => {
          ...
          <button
            className={`btn flex-1 ${filterType === "emotion" ? "btn-primary" : "bg-base-100 hover:bg-base-200"}`}
            onClick={() => {
        ...
        <div className="grid grid-cols-3 gap-2 mb-6">
          {(filterType === "category" ? categories : emotions).map((item) => (
            <button
              key={item}
              className={`btn btn-sm ${selectedFilter === item ? "btn-primary" : "bg-base-100 hover:bg-base-200"}`}
              onClick={() => {
